...
# Load settings
$settings = Get-Content 'C:\VSCode\labs\msgraph-training-powershell\graphtutorial\settings.json' -ErrorAction Stop | Out-String | ConvertFrom-Json
...
# HT 27/06/25: -ContextScope Process is workaround for Auth bug - https://github.com/microsoftgraph/msgraph-sdk-powershell/issues/3197#issuecomment-2896474896
